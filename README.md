Instruksi utk nyalain web:

1. arahkan terminal ke backend (atau ketik "cd backend" di terminal)
2. di terminal ketik "python -m venv venv" ENTER
3. ketik lagi di terminal "venv\Scripts\activate" ENTER
4. ketik lagi di terminal "python run.py" for se menyala backend

sekarang se nyala frontend
